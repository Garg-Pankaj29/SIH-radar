...
import { LuSparkles, LuTrendingUp, LuTriangleAlert, LuUsers, LuCircleCheck } from "react-icons/lu";
  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: "24px", maxWidth: "1000px" }}>
        {/* Mission Card */}
        <div className="card">
          <h2 className="section-title" style={{ fontSize: "1.1rem", fontWeight: "800", marginBottom: "12px" }}>
            Mission &amp; Objective
          </h2>
        ...
        <div className="card">
          <h2 className="section-title" style={{ fontSize: "1.1rem", fontWeight: "800", marginBottom: "16px" }}>
        ...
        <div className="card">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "0.85rem", color: "var(--text-secondary)", lineHeight: "1.7" }}>
            <div style={{ display: "flex", gap: "8px", alignItems: "flex-start" }}>
              <LuCircleCheck size={16} color="var(--accent)" style={{ flexShrink: 0, marginTop: "3px" }} />
